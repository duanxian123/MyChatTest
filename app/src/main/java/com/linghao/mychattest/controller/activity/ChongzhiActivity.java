...
import com.linghao.mychattest.utils.pay.PayKeys;
import com.linghao.mychattest.utils.pay.PayResult;
import com.linghao.mychattest.utils.pay.SignUtils;
        ...
        chongzhiEt.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (TextUtils.isEmpty(moneyNum)) {//空
                    //1.设置Button的背景颜色
                    chongzhiBtn.setBackgroundResource(R.drawable.btn_02);
                    //2.设置Button可点击性
